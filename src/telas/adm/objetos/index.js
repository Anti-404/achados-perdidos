...
class Objetos{
    ...
    irParaInteracao(){  
        ...
        for (let i = 0; i < tds.length; i++) {
            ...
            tds[i].addEventListener("click", (e)=>{            
                ...
                window.location.href = `http://localhost/smd/projeto/src/telas/adm/objetos/subtelas/interacao/?id=${id}`;
    ...
    irParaCadObj(){
        document.querySelector("#btnCadObj").addEventListener("click",(e)=>{            
            e.preventDefault();              
            window.location.href = "http://localhost/smd/projeto/src/telas/adm/objetos/subtelas/cadastro/";           
       ...
       const lis =  document.querySelectorAll("ul li");
        ...
        for (let i = 0; i < lis.length; i++) {
            ...
            lis[i].addEventListener("click", async (e)=>{            
                ...
                //document.querySelector("tbody tr").parentElement.removeChild(document.querySelector("tbody tr"));
